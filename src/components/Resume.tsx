...
const roles = [
  ...
  },
  {
    ...
    highlights: [
      <><strong>Reduced checkout abandonment by 14%</strong> in an A/B test by launching shipping discovery that showed customers multiple carrier options with transparent 70%+ savings comparisons, reducing uncertainty around shipping costs at checkout for a platform serving 40,000+ merchants.</>,
